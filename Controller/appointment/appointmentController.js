...
export const addAppointment = async (req, res) => {
    const { patientFirstName, patientLastName, patientAge, patientGender, patientPhoneNumber, userId, doctorId, mode, slotId, date } = req.body;
    ...
    if (!patientFirstName || !patientLastName || !patientAge || !patientGender || !patientPhoneNumber || !userId || !doctorId || !mode || !slotId || !date) {
...
export const handleUpload = async (req, res) => {
    uploadPrescriptionImage(req, res, async (err) => {
        try {
            ...
            console.log(await prisma.appointment.update({
